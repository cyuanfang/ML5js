...
function setup() {
  ...
  img = createImg('images/bigcat.jpg', imgReady); // Load the image
  classifier = ml5.imageClassifier('MobileNet', modelReady); // Initialize the Image Classifier method with MobileNet. A callback needs to be passed.
}
